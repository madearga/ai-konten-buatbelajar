 ...
 */
declare function update<Config extends SourceConfig>(source: StaticSource<Config>): _SourceUpdate_<Config>;
...
//#endregion
export { ResolvedLoaderConfig as A, PageTreeTransformer as B, LoaderConfig as C, LoaderPluginOption as D, LoaderPlugin as E, slugsFromData as F, ContentStorageMetaFile as H, slugsPlugin as I, PageTreeBuilder as L, loader as M, SlugFn as N, Meta as O, getSlugs as P, PageTreeBuilderContext as R, InferPageType as S, LoaderOutput as T, ContentStoragePageFile as U, ContentStorage as V, FileSystem as W, update as _, MetaData as a, dynamicLoader as b, SourceConfig as c, VirtualFile as d, _SourceUpdate_ as f, source as g, multiple as h, DynamicSource as i, createGetUrl as j, Page as k, SourceUnion as l, isStaticSource as m, llms as n, PageData as o, isDynamicSource as p, path_d_exports as r, Source as s, LLMsConfig as t, StaticSource as u, DynamicLoader as v, LoaderOptions as w, InferMetaType as x, DynamicLoaderConfig as y, PageTreeOptions as z };